...
("myfunc" . ("PKG.info" 1045 350 "Functions and Variables for PKG"))
("myfunc2" . ("PKG.info" 1241 162 "Functions and Variables for PKG"))
("myvar" . ("PKG.info" 991 49 "Functions and Variables for PKG"))
))
(section-pairs '(
; CONTENT: (<NODE NAME> . (<FILENAME> <BYTE OFFSET> <LENGTH IN CHARACTERS>))
("Functions and Variables for PKG" . ("PKG.info" 919 591))
